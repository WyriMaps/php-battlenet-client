...
/**
 * @EmptyResource("WorldOfWarcraft\EmptyCharacterAchievement")
 */
abstract class CharacterAchievement extends AbstractResource implements CharacterAchievementInterface
{
    /**
     * @var int
     */
